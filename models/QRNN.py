...
# https://arxiv.org/pdf/1611.01576.pdf?fbclid=IwAR3hreOvBGmJZe54-631X49XedcbsQoDYIRu87BcCHEBf_vMKF8FDKK_7Nw
...
class QRNN(nn.Module):
    # Poolin can be: "f"; "fo"; "ifo";
    def __init__(self, batch_size, output_size, hidden_size, vocab_size, embedding_length, weights, num_layers=4, kernel_size=2, pooling='fo', zoneout=0.5, dropout=0.3, dense=True):
